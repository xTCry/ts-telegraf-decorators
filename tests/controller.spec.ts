...
describe('Add Metadata Controller', () => {
    it('add controller', function () {
        expect(
            MetadataArgsStorage.composerMetadata.find((value) => value.target.prototype == TestController.prototype),
        ).toBeDefined();
    });

    it('add start', function () {
        expect(
            MetadataArgsStorage.handlers.find(
                (value) => value.target == TestController.prototype && value.type == 'start',
            ),
        ).toBeDefined();
    });
    ...
    it('add help', function () {
        expect(
            MetadataArgsStorage.handlers.find(
                (value) => value.target == TestController.prototype && value.type == 'help',
            ),
        ).toBeDefined();
    });
    ...
    it('add action', function () {
        expect(
            MetadataArgsStorage.handlers.find(
                (value) => value.target == TestController.prototype && value.type == 'action',
            ),
        ).toBeDefined();
    });
    ...
    it('add command', function () {
        expect(
            MetadataArgsStorage.handlers.find(
                (value) => value.target == TestController.prototype && value.type == 'command',
            ),
        ).toBeDefined();
    });
    ...
    it('add hears', function () {
        expect(
            MetadataArgsStorage.handlers.find(
                (value) => value.target == TestController.prototype && value.type == 'hears',
            ),
        ).toBeDefined();
    });
    ...
    it('add inject parameters', function () {
        expect(
            MetadataArgsStorage.paramMetadata.find(
                (value) => value.target == TestController.prototype && value.propertyName == 'start',
            ),
        ).toBeDefined();
    });
});
